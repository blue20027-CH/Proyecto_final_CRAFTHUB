...
class PantallaEventosComprador extends StatefulWidget {
  ...
  @override
  State<PantallaEventosComprador> createState() => _PantallaEventosCompradorState();
}
...
class _PantallaEventosCompradorState extends State<PantallaEventosComprador> {
  ...
  Widget _buildCta() {
    return BannerCtaEvento(
      ...
      subtitulo: 'Reserva tu mesa en las mejores ferias artesanales del país y date a conocer.',
      textoBoton: 'Conviértete en vendedor',
      onPressed: () {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Función disponible desde tu perfil de vendedor.')),
        );
      },
    );
  }
