...
class _HomeCompradorState extends State<HomeComprador> {
  ...
  Widget _buildTopBar(bool oscuro) {
    void abrirMapa() => Navigator.push(
      context,
      MaterialPageRoute(
        builder: (ctx) =>
            PantallaMapa(esOscuro: Theme.of(ctx).brightness == Brightness.dark),
      ),
    );
    ...
    void abrirMensaje() {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (ctx) => const PantallaMensajesComprador()),
      );
    }
    ...
    return TopbarFlotante(
      ...
      alPresionarMensajes: abrirMensaje,
