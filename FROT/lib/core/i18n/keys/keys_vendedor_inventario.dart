const Map<String, Map<String, String>> traducciones = {
  ...
  'vendedor_inventario.seccion_tallas': {'es': 'Tallas disponibles', 'en': 'Available sizes'},
  'vendedor_inventario.tip_tallas': {
    'es': 'Marca las tallas que tienes disponibles. Solo aplica a ropa y calzado.',
    'en': 'Select the sizes you have available. Only applies to clothing and footwear.',
  },
  'vendedor_inventario.sube_una_imagen': {'es': 'Sube una imagen', 'en': 'Upload an image'},
  'vendedor_inventario.formatos_imagen': {'es': 'JPG, PNG o WebP · Máx. 5 MB', 'en': 'JPG, PNG or WebP · Max 5 MB'},
  'vendedor_inventario.cambiar_imagen': {'es': 'Cambiar', 'en': 'Change'},
  'vendedor_inventario.o_pega_url': {'es': 'O pega una URL', 'en': 'Or paste a URL'},
  'vendedor_inventario.o_sube_archivo': {'es': 'o sube tu archivo', 'en': 'or upload your file'},
  'vendedor_inventario.subir_video_dispositivo': {'es': 'Subir video desde el dispositivo', 'en': 'Upload video from device'},
  'vendedor_inventario.subiendo_video': {'es': 'Subiendo video...', 'en': 'Uploading video...'},
  'vendedor_inventario.error_seleccionar_video': {'es': 'No se pudo seleccionar el video: ', 'en': "Couldn't select the video: "},
