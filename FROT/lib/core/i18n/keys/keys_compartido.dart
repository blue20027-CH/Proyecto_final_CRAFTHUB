const Map<String, Map<String, String>> traducciones = {
  ...
  'compartido.volver': {'es': 'Volver', 'en': 'Back'},
  'compartido.tambien_podria_gustarte': {'es': 'También podría gustarte', 'en': 'You might also like'},
  ...
  'compartido.ia_escribiendo': {'es': 'Crafty está escribiendo...', 'en': 'Crafty is typing...'},
  'compartido.ia_titulo_perfil': {'es': 'Tu perfil según la IA', 'en': 'Your profile, according to AI'},
  'compartido.ia_analizando_perfil': {'es': 'La IA está analizando tu perfil...', 'en': 'The AI is analyzing your profile...'},
  'compartido.ia_reanalizar': {'es': 'Volver a analizar', 'en': 'Re-analyze'},
  'compartido.ia_generar_descripcion': {'es': 'Generar con IA', 'en': 'Generate with AI'},
  'compartido.ia_mejorar_descripcion': {'es': 'Mejorar con IA', 'en': 'Improve with AI'},
  'compartido.personalidad_marca_label': {'es': 'Personalidad de tu marca', 'en': 'Your brand personality'},
  'compartido.personalidad_marca_ayuda': {
    'es': 'La IA usará este tono al generar los nombres y descripciones de tus productos.',
    'en': 'The AI will use this tone when generating your product names and descriptions.',
  },
