...
class SidebarVendedor extends StatefulWidget {
  ...
  @override
  State<SidebarVendedor> createState() => _SidebarVendedorState();
}

class _SidebarVendedorState extends State<SidebarVendedor>
  ...
  // Ítems de navegación del vendedor
  static const _items = [
  ...
  Widget _buildPerfil() {
    // 🔌 GET /api/vendedor/perfil → nombre, fotoUrl, tienda, verificado
    return Padding(
...
// ─────────────────────────────────────────────────────────────
// ÍTEM NAV — idéntico al del comprador
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// BOTÓN TOGGLE — idéntico al del comprador
// ─────────────────────────────────────────────────────────────
